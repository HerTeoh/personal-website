...
const milestones = [
  { label: "Minerva University", sub: "Computer Science & Business" },
  { label: "Data Engineer", sub: "Neuron Mobility" },
  { label: "Operations Excellence", sub: "Neuron Mobility" },
  { label: "Entrepreneur", sub: "Fitness Franchise" },
  { label: "Asst. Portfolio Manager", sub: "Singular Asset Management" },
];
